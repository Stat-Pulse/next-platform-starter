        ...
        <div className="container mx-auto px-6 space-y-10">
          ...
          <section className="flex flex-col items-center text-center space-y-4">
            ...
            <p className="text-sm text-gray-500">
              Next Game: vs Chiefs — May 15, 2025 @ 4:25 PM EST (
              <Link href="/schedule-results" className="text-red-600 underline">Full Schedule</Link>
              )
            </p>
          </section>
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  <li>
                    <Link href="/league-news" className="text-red-600 hover:underline">
                      Burrow returns to full practice ahead of Chiefs matchup
                    </Link>
                  </li>
                  <li>
                    <Link href="/league-news" className="text-red-600 hover:underline">
                      Bengals sign veteran CB to bolster secondary
                    </Link>
                  </li>
                </ul>
              </div>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="p-2">
                      <Link href="/players/joe-burrow" className="text-red-600 hover:underline">
                        Joe Burrow
                      </Link>
                    </td>
                  ...
                  <tr>
                    ...
                    <td className="p-2">
                      <Link href="/players/joe-mixon" className="text-red-600 hover:underline">
                        Joe Mixon
                      </Link>
                    </td>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-4 rounded shadow">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  ...
                  <li>
                    Rushing:{' '}
                    <Link href="/players/bijan-robinson" className="text-red-600 hover:underline">
                      Bijan Robinson
                    </Link>{' '}
                    – 1,140 yds
                  </li>
